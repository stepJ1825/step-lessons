...
/**
 * Основная концепция:
 * PhantomReference - это механизм для отслеживания момента,
 * когда объект уже окончательно удален из памяти (после вызова finalize()),
 * но до того как память будет переиспользована.
