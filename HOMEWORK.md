...
---------------------------------
1. Написанное на Java-config приложение будет находится в 'develop ветке.
2. От ветки 'develop' нужно ответвится и создать новую ветку 'feature/web-controller'
3. Переписать слой контроллеров с использованием аннотаций @Controller и @RestController, \
...
4. Создать пул-реквест 'feature/web-controller'>'develop'.
5. Сбросить пул-реквест в группу в ТГ и получить аппрув или замечания.
6. После получения аппрува выполнить слияние.
